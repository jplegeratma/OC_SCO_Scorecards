-- OC SQL from Informatica
-- Includes Nicole's SQL and Provider SQL

CREATE TABLE MHTEAM.DWDQ.INF_B_SC_OC_DOS_~MON_output~ AS
SELECT
...
CSA.CDE_PLACE_OF_SERVICE_ENC,  /*added 6.8.18 for Q3 refresh: begin*/
CSA.CDE_TYPE_OF_BILL,
CSA.CDE_TYPE_OF_BILL_ENC,
CSA.CDE_BILL_FREQ,      /*added 6.8.18 for Q3 refresh: end*/
...
CREATE TABLE MHTEAM.DWDQ.INF_B_SC_OC_TRANSPOSE2_~MON~
AS
SELECT MEAS, 
       "'CCI'" AS CCI, 
       "'NWI'" AS NWI,
...
CREATE TABLE MHTEAM.DWDQ.INF_B_SC_OC_TRANSPOSE22_~MON~
AS
...
create table MHTEAM.DWDQ.INF_B_SC_OC_REP_STEP1_~MON~
as
select 
...
INSERT INTO MHTEAM.DWDQ.INF_B_SC_STG_OC_FAILS
-- SCO_FAIL1
SELECT * FROM (
WITH SCO_FAIL1 AS (
SELECT DISTINCT
...
FROM MHTEAM.DWDQ.INF_B_SC_STG_OC_DOS 
WHERE 
...
SELECT
  ...
  FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
...
SELECT
  ...
  FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL21 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL22
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL22 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL23
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL23 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL24
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL24 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL25
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL25 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL26
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL26 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL27
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL27 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL28
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL28 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL29
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL29 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL30 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
*/
UNION
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL31 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL32
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL32 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL33
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL33 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL34
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL34 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL35
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL35 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL36
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL36 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
)
UNION
-- _OC_FAIL37
...
FROM  
MHTEAM.DWDQ.INF_B_SC_STG_OC_SCORECARD_LOOKUP L
JOIN _OC_FAIL37 F ON L.ID = F.ID 
ORDER BY L.ID, CDE_ENC_MCO,   ENC_CLAIM_NO, ENC_CLAIM_SUFFIX
);
...
--TRUNCATE TABLE INF_B_SC_STG_OC_PROVIDER;

INSERT INTO MHTEAM.DWDQ.INF_B_SC_STG_OC_PROVIDER
         SELECT
         TO_DATE('~ASOFDT~','YYYYMMDD') as RUN_DATE,
         ENC.CDE_ENC_MCO, 
         MEM.ID_MEDICAID,
...
INSERT INTO MHTEAM.DWDQ.INF_B_SC_STG_OC_PROVIDER_MISSING_IDS

with INF_SC_OC_PROVIDER_SERV 
AS (
...
--TRUNCATE TABLE MHTEAM.DWDQ.INF_B_SC_STG_OC_PROVIDER_STATS;

INSERT INTO MHTEAM.DWDQ.INF_B_SC_STG_OC_PROVIDER_STATS
...
FROM (
select TO_DATE('~ASOFDT~','YYYYMMDD') AS RUN_DATE, 'CCI' AS CDE_ENC_MCO from DUAL 
UNION 
