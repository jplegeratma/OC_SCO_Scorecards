...
<root xmlns=\"http://www.informatica.com/Parameterization/1.0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema\" version=\"2.0\">
    <project name=\"b_DW_Monitoring_Project\">
        <folder name=\"MCE_Encounter_ANOMALY_SQLs\">
            <mapping name=\"MCO_MBHP_DOS_Pull\">
                ...
                <parameter name=\"TABLE_MON\">b_DW_Monitoring_Project/MCE_Encounter_ANOMALY_SQLs/RelationalDataObject:MCO_MBHP_DOS_SEP2018_DEC2018</parameter>
            </mapping>
        </folder>
    </project>
</root>" > $DA_PARAM_FILE
...
#            step_12
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 1 failed - APP_INF_B_DA_MNTH_MCO_CLMTYP failed "
            error_msg_ex  " step 1, executing APP_INF_B_DA_MNTH_MCO_CLMTYP "
        fi
