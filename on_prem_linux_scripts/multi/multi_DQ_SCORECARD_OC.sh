...
script_name="multi_DQ_SCORECARD_OC.sh"
...
step_1 ()
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Name:    set_OC_RUN_DATE_TO_MAX_OFFSET_MNTHS (db_connect_string)
# Notes:   Taken from function get_run_date
# This may be written as a function 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#set_OC_RUN_DATE_TO_MAX_OFFSET_MNTHS ()
{
        # Local variables
        local lgrd_db_connect_str="${DW_USER}/${DW_PASS}@${DW_SID}"

echo "OC_RUN_DATE_TO_MAX_OFFSET_MNTHS: ${OC_RUN_DATE_TO_MAX_OFFSET_MNTHS}"

    if [ -n "$OC_RUN_DATE_TO_MAX_OFFSET_MNTHS" ]
    then
        # Overwrite the value in the nw_params table
        local query="update INF_B_DQ_PARAMS set PARAM_VALUE = '${OC_RUN_DATE_TO_MAX_OFFSET_MNTHS}' where PARAM_NAME = 'OC_RUN_DATE_TO_MAX_OFFSET_MNTHS'";
...
step_2 ()
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Name:    set_OC_RUN_MNTHS (db_connect_string)
# Notes:   Taken from function get_run_date
# This may be written as a function
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#set_OC_RUN_MNTHS ()
...
echo "OC_RUN_MNTHS: ${OC_RUN_MNTHS}"

        # Get the run date from dw_params table
        local query="update INF_B_DQ_PARAMS set PARAM_VALUE = '${OC_RUN_MNTHS}' where PARAM_NAME = 'OC_RUN_MNTHS'";
...
echo "multi_OC_DQ SCORECARD Informatica Job completed successfully."
send_email "${email_recepient}" "($script_name) is done" "multi_OC_DQ SCORECARD Informatica Job completed successfully."
echo "Info: ($script_name) multi OC DQ SCORECARD Monthly Load -- Completed at: `date` "
