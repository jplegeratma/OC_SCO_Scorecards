...
<root xmlns=\"http://www.informatica.com/Parameterization/1.0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema\" version=\"2.0\">
    <project name=\"b_DW_Monitoring_Project\">
        <folder name=\"DI_Anomaly_Scorecards\">
            ...
            <workflow name=\"WKF_INF_B_DA_MNTH_MCO_CLMTYP\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_MCO_CLMTYP</parameter>
                <parameter name=\"step_num\">13</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_MCO_CLMTYP</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
            <workflow name=\"WKF_INF_B_DA_MNTH_MCO_ACO_CLMTYP\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_MCO_ACO_CLMTYP</parameter>
                <parameter name=\"step_num\">14</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_MCO_ACO_CLMTYP</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
            <workflow name=\"WKF_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP</parameter>
                <parameter name=\"step_num\">15</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
            <workflow name=\"WKF_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP}</parameter>
                <parameter name=\"step_num\">16</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
            <workflow name=\"WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP</parameter>
                <parameter name=\"step_num\">17</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
            <workflow name=\"WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP</parameter>
                <parameter name=\"step_num\">18</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
            <workflow name=\"WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A</parameter>
                <parameter name=\"step_num\">19</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
            <workflow name=\"WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B\">
                <parameter name=\"DA_BATCH_SEQ\">${lgrd_batch_seq}</parameter>
                <parameter name=\"DA_RUN_DATE\">${lgrd_run_date}</parameter>
                <parameter name=\"DA_MIN_DOS\">${DA_MIN_DOS}</parameter>
                <parameter name=\"DA_MAX_DOS\">${DA_MAX_DOS}</parameter>
                <parameter name=\"program_name\">WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B</parameter>
                <parameter name=\"step_num\">20</parameter>
                <parameter name=\"table_name\">INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B</parameter>
                <parameter name=\"project_name\">DA</parameter>
            </workflow>
        </folder>
    </project>
...
step_13 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_MCO_CLMTYP Workflow: WKF_INF_B_DA_MNTH_MCO_CLMTYP
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_B_DA_MNTH_MCO_CLMTYP"
    ...
    if [ "$success_code" -eq 0 ]
       then
            echo "Info: ($script_name) APP_INF_B_DA_MNTH_MCO_CLMTYP completed at: `date` "
            sleep 20
            step_14
       else
            send_email "${email_recepient}" "Error in ($script_name)" "step 13 failed - APP_INF_B_DA_MNTH_MCO_CLMTYP failed "
            error_msg_ex  " step 13, executing APP_INF_B_DA_MNTH_MCO_CLMTYP "
        fi
...
step_14 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_MCO_ACO_CLMTYP Workflow: WKF_INF_B_DA_MNTH_MCO_ACO_CLMTYP
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_B_DA_MNTH_MCO_ACO_CLMTYP"
    ...
    while [[ "$success_code" -eq 1 && "$cnt" -le "$cntr" ]]
    do
            infacmd.sh wfs startWorkflow -dn $DOMAIN -sn $INF_SERVER -un $INF_USER -pd $INF_PASS -a APP_INF_B_DA_MNTH_MCO_ACO_CLMTYP -wf WKF_INF_B_DA_MNTH_MCO_ACO_CLMTYP -pf DA_PARAMETERS.xml 
    ...
    if [ "$success_code" -eq 0 ]
       then
            echo "Info: ($script_name) APP_INF_B_DA_MNTH_MCO_ACO_CLMTYP completed at: `date` "
            sleep 20
            step_15
       else
            send_email "${email_recepient}" "Error in ($script_name)" "step 14 failed - INF_B_DA_MNTH_MCO_ACO_CLMTYP failed "
            error_msg_ex  " step 14, executing APP_INF_B_DA_MNTH_MCO_ACO_CLMTYP "
        fi
...
step_15 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP Workflow: WKF_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP"
    ...
    while [[ "$success_code" -eq 1 && "$cnt" -le "$cntr" ]]
    do
            infacmd.sh wfs startWorkflow -dn $DOMAIN -sn $INF_SERVER -un $INF_USER -pd $INF_PASS -a APP_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP -wf WKF_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP -pf DA_PARAMETERS.xml
    ...
    if [ "$success_code" -eq 0 ]
       then
            echo "Info: ($script_name) APP_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP completed at: `date` "
            sleep 20
            step_16
       else
            send_email "${email_recepient}" "Error in ($script_name)" "step 15 failed - INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP failed "
            error_msg_ex  " step 15, executing APP_INF_B_DA_MNTH_CLMNUM_MCO_CLMTYP "
        fi
...
step_16 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP Workflow: WKF_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP"
    ...
    while [[ "$success_code" -eq 1 && "$cnt" -le "$cntr" ]]
    do
            infacmd.sh wfs startWorkflow -dn $DOMAIN -sn $INF_SERVER -un $INF_USER -pd $INF_PASS -a APP_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP -wf WKF_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP -pf DA_PARAMETERS.xml
    ...
    if [ "$success_code" -eq 0 ]
       then
            echo "Info: ($script_name) APP_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP completed at: `date` "
            sleep 20
            step_17
       else
            send_email "${email_recepient}" "Error in ($script_name)" "step 16 failed - INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP failed "
            error_msg_ex  " step 16, executing APP_INF_B_DA_MNTH_CLMNUM_MCO_ACO_CLMTYP "
        fi
...
step_17 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP Workflow: WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP"
    ...
    while [[ "$success_code" -eq 1 && "$cnt" -le "$cntr" ]]
    do
            infacmd.sh wfs startWorkflow -dn $DOMAIN -sn $INF_SERVER -un $INF_USER -pd $INF_PASS -a APP_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP -wf WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP -pf DA_PARAMETERS.xml
    ...
    if [ "$success_code" -eq 0 ]
       then
            echo "Info: ($script_name) APP_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP completed at: `date` "
            sleep 20
            step_18
       else
            send_email "${email_recepient}" "Error in ($script_name)" "step 17 failed - INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP failed "
            error_msg_ex  " step 17, executing APP_INF_B_DA_MNTH_UTIL_MEM_MCO_CLMTYP "
        fi
...
step_18 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP Workflow: WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP"
    ...
    while [[ "$success_code" -eq 1 && "$cnt" -le "$cntr" ]]
    do
            infacmd.sh wfs startWorkflow -dn $DOMAIN -sn $INF_SERVER -un $INF_USER -pd $INF_PASS -a APP_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP -wf WKF_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP -pf DA_PARAMETERS.xml
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 18 failed - INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP failed "
            error_msg_ex  " step 18, executing APP_INF_B_DA_MNTH_UTIL_MEM_MCO_ACO_CLMTYP "
        fi
...
step_19 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A Workflow: WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A"
    ...
    while [[ "$success_code" -eq 1 && "$cnt" -le "$cntr" ]]
    do
            infacmd.sh wfs startWorkflow -dn $DOMAIN -sn $INF_SERVER -un $INF_USER -pd $INF_PASS -a APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A -wf WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A -pf DA_PARAMETERS.xml
    ...
    if [ "$success_code" -eq 0 ]
       then
            echo "Info: ($script_name) APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A completed at: `date` "
            sleep 20
            step_20
       else
            send_email "${email_recepient}" "Error in ($script_name)" "step 19 failed - INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A failed "
            error_msg_ex  " step 19, executing APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_A "
        fi
...
step_20 ()
{
    ########## Run Application: APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B Workflow: WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B
    echo "Info: ($script_name) Executing Workflow  - WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B"
    ...
    while [[ "$success_code" -eq 1 && "$cnt" -le "$cntr" ]]
    do
            infacmd.sh wfs startWorkflow -dn $DOMAIN -sn $INF_SERVER -un $INF_USER -pd $INF_PASS -a APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B -wf WKF_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B -pf DA_PARAMETERS.xml
    ...
    if [ "$success_code" -eq 0 ]
       then
            echo "Info: ($script_name) APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B completed at: `date` "
            sleep 20
#            step_21
            step_41
       else
            send_email "${email_recepient}" "Error in ($script_name)" "step 20 failed - INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B failed "
            error_msg_ex  " step 20, executing APP_INF_B_DA_MNTH_REVCDE_CLMNUM_MCO_CLMTYP_B "
        fi
