...
step_12 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 2 failed - APP_INF_B_SC_MCO_MBH_TOTREX failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_TOTREX "
        fi
...
step_13 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 3 failed - APP_INF_B_SC_MCO_MBH_TDOS failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_TDOS "
        fi
...
step_14 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 4 failed - APP_INF_B_SC_MCO_MBH_FLDREX failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_FLDREX "
        fi
...
step_15 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 5 failed - APP_INF_B_SC_MCO_MBH_FRDOS failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_FRDOS "
        fi
...
step_16 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 6 failed - APP_INF_B_SC_MCO_MBH_PCNT failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_PCNT "
        fi
...
step_17 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 7 failed - APP_INF_B_SC_MCO_MBH_PCTDOS failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_PCTDOS "
        fi
...
step_18 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 8 failed - APP_INF_B_SC_MCO_MBH_TPDOS failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_TPDOS "
        fi
...
step_19 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 9 failed - APP_INF_B_SC_MCO_MBH_FRPDOS failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_FRPDOS "
        fi
...
step_20 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 10 failed - APP_INF_B_SC_MCO_MBH_PTPDOS failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_PTPDOS "
        fi
...
step_21 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 11 failed - APP_INF_B_SC_MCO_MBH_REP_TRANSPOSE failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_REP_TRANSPOSE "
        fi
...
step_22 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 12 failed - APP_INF_B_SC_MCO_MBH_REP_STEP1 failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_REP_STEP1 "
        fi
...
step_23 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            send_email "${email_recepient}" "Error in ($script_name)" "step 13 failed - APP_INF_B_SC_MCO_MBH_REP_STEP2 failed "
            error_msg_ex  " step 1, executing APP_INF_B_SC_MCO_MBH_REP_STEP2 "
        fi
