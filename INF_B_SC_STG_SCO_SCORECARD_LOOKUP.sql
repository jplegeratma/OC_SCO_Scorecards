/*
DROP TABLE INF_B_SC_STG_SCO_SCORECARD_LOOKUP CASCADE CONSTRAINTS;

CREATE TABLE INF_B_SC_STG_SCO_SCORECARD_LOOKUP
(
  ID                   NUMBER(4),
  BENCHMARK            VARCHAR2(50 BYTE),
...
*/
truncate table INF_B_SC_STG_SCO_SCORECARD_LOOKUP;

Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
...
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
 ...
 Values
   (38, 'Servicing Provider Specialty', 'PCT_SERV_PROV_SPEC', '56', 'All Claim Types', 
    0.5);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, CLAIM_TYPE, BENCHMARK_THRESHOLD)
 Values
   (39, 'Billing Provider Specialty', 'PCT_BILL_PROV_SPEC', 'All Claim Types', 0.5);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
...
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (46, 'Servicing Provider Last Name', 'PCT_SERV_NAM_LAST', '6', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (47, 'Billing Provider Last Name', 'PCT_BILL_NAM_LAST', '6', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (48, 'Servicing Provider Street Address', 'PCT_SERV_ADR_STRT', '8', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (49, 'Billing Provider Street Address', 'PCT_BILL_ADR_STRT', '8', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (50, 'Servicing Provider City Address', 'PCT_SERV_ADR_CITY', '9', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (51, 'Billing Provider City Address', 'PCT_BILL_ADR_CITY', '9', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (52, 'Servicing Provider State Address', 'PCT_SERV_ADR_STATE', '10', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (53, 'Billing Provider State Address', 'PCT_BILL_ADR_STATE', '10', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (54, 'Servicing Provider Zip Address', 'PCT_SERV_ADR_ZIP', '11', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (55, 'Billing Provider Zip Address', 'PCT_BILL_ADR_ZIP', '11', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (56, 'Servicing Provider Street Mailing Address', 'PCT_SERV_ADR_MAIL_STRT', '12', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (57, 'Billing Provider Street Mailing Address', 'PCT_BILL_ADR_MAIL_STRT', '12', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (58, 'Servicing Provider City Mailing Address', 'PCT_SERV_ADR_MAIL_CITY', '13', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (59, 'Billing Provider City Mailing Address', 'PCT_BILL_ADR_MAIL_CITY', '13', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (60, 'Servicing Provider State Mailing Address', 'PCT_SERV_ADR_MAIL_STATE', '14', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (61, 'Billing Provider State Mailing Address', 'PCT_BILL_ADR_MAIL_STATE', '14', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (62, 'Servicing Provider Zip Mailing Address', 'PCT_SERV_ADR_MAIL_ZIP', '15', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (63, 'Billing Provider Zip Mailing Address', 'PCT_BILL_ADR_MAIL_ZIP', '15', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (64, 'Servicing Provider Accepting New Patients', 'PCT_SERV_PANEL_OPEN', '23', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (65, 'Billing Provider Accepting New Patients', 'PCT_BILL_PANEL_OPEN', '23', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (66, 'Servicing Provider NPI', 'PCT_SERV_NPI_SCO', '26', 'All Claim Types', 
    0.98);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (67, 'Billing Provider NPI', 'PCT_BILL_NPI_SCO', '26', 'All Claim Types', 
    0.98);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (68, 'Servicing Tax ID', 'PCT_SERV_TAX_ID', '30', 'All Claim Types', 
    0.98);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (69, 'Billing Tax ID', 'PCT_BILL_TAX_ID', '30', 'All Claim Types', 
    0.98);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (70, 'Servicing Provider Primary Care Eligibility Ind', 'PCT_SERV_PC_ELIG_IND', '33', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (71, 'Billing Provider Primary Care Eligibility Ind', 'PCT_BILL_PC_ELIG_IND', '33', 'All Claim Types', 
    0.95);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (72, 'Servicing Provider APCD Organization ID', 'PCT_SERV_APCD_ORGID', '34', 'All Claim Types', 
    0.5);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (73, 'Billing Provider APCD Organization ID', 'PCT_BILL_APCD_ORGID', '34', 'All Claim Types', 
    0.5);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (74, 'Servicing Provider Bundle ID', 'PCT_SERV_PROV_BUNDLE_ID', '40', 'All Claim Types', 
    0.5);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (75, 'Billing Provider Bundle ID', 'PCT_BILL_PROV_BUNDLE_ID', '40', 'All Claim Types', 
    0.5);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (76, 'Servicing Provider Primary Address Location Indicator', 'PCT_SERV_IND_PRIM_ENC_PROV_LOC', '41', 'All Claim Types', 
    0.5);
Insert into INF_B_SC_STG_SCO_SCORECARD_LOOKUP
   (ID, BENCHMARK, BENCHMARK_NAME, FIELD_ID, CLAIM_TYPE, 
    BENCHMARK_THRESHOLD)
 Values
   (77, 'Billing Provider Primary Address Location Indicator', 'PCT_BILL_IND_PRIM_ENC_PROV_LOC', '41', 'All Claim Types', 
    0.5);
COMMIT;
