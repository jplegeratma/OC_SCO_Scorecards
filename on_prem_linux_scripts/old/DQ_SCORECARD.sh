...
#            step_51
            ...
            error_msg_ex  " step 21, executing APP_INF_B_SC_STG_MCO_MBH_REP_TRANSPOSE "
        fi
...
step_33 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            error_msg_ex  " step 22, executing APP_INF_B_SC_STG_MCO_MBH_REP_STEP1 "
        fi
...
step_34 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            error_msg_ex  " step 23, executing APP_INF_B_SC_STG_MCO_MBH_REP_STEP2 "
        fi
...
step_35 ()
{
    ...
    if [ "$success_code" -eq 0 ]
       then
            ...
            error_msg_ex  " step 23, executing APP_INF_B_SC_STG_MCO_MBH_REP_STEP3 "
        fi
